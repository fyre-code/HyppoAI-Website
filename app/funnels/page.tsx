    ...
    <>
      <section className="bg-black min-h-[80vh] flex flex-col justify-center px-6 py-24 border-b border-[#1a1a1a]">
        <div className="max-w-[1170px] mx-auto relative z-10">
          <HeroText><p className="text-[#2cd9fe] text-xs uppercase tracking-widest mb-4">System 06 — Funnels</p></HeroText>
          <HeroText>
            <h1 className="text-5xl md:text-8xl font-bold text-[#c9c9c9] leading-tight max-w-4xl mb-6">
              Turn Clicks Into <span className="text-[#2cd9fe]">Clients</span>
            </h1>
          </HeroText>
          <HeroText>
            <p className="text-[#c9c9c9] text-[21px] max-w-2xl mb-10 leading-relaxed">
      ...
      <section className="bg-[#0a0a0a] py-20 px-6 border-b border-[#1a1a1a]">
        <div className="max-w-[1170px] mx-auto flex flex-col md:flex-row gap-16 items-center">
          <FadeLeft className="md:w-1/2">
            ...
            <h2 className="text-[28px] md:text-[48px] font-bold text-[#c9c9c9] mb-6">Ads Drive Traffic. Funnels Convert It.</h2>
            <p className="text-[#c9c9c9] leading-relaxed text-[21px] mb-4">
          ...
          <FadeRight className="md:w-1/2">
            <div className="border border-[#1a1a1a] p-10 bg-black">
              ...
              {['Ad spend goes to a page that doesn\'t convert', 'Leads opt in but never get followed up', 'No system for moving a prospect to a booking', 'You can\'t track what\'s working or why'].map((item) => (
                <div key={item} className="flex items-start gap-3 mb-4 text-[#c9c9c9]">
      ...
      <section className="bg-black py-20 px-6 border-b border-[#1a1a1a]">
        <div className="max-w-[1170px] mx-auto">
          <FadeUp>
            ...
            <h2 className="text-[28px] md:text-[48px] font-bold text-[#c9c9c9] mb-16">Inside the Funnels System</h2>
          </FadeUp>
      ...
      <section className="bg-[#0a0a0a] py-20 px-6">
        <div className="max-w-[1170px] mx-auto text-center">
          <FadeUp>
            <h2 className="text-[28px] md:text-[48px] font-bold text-[#c9c9c9] mb-4">Build a Funnel That Actually Converts</h2>
